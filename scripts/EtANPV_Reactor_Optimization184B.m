...
for j = 2:2:10
    ...
    for i = 225:5:240
        ...
        for y = 1
            ...
            %         ad = 1;
            %         aij = 2.33;
            %         xa = PEther.(labelP{countP}).(labelT{countT})./PTotal.(labelP{countP}).(labelT{countT});
            %         xb = PEthanol.(labelP{countP}).(labelT{countT})./PTotal.(labelP{countP}).(labelT{countT});
            %         xc = PEtA./PTotal.(labelP{countP}).(labelT{countT});
            %         xd = PEther.(labelP{countP}).(labelT{countT})./PTotal.(labelP{countP}).(labelT{countT});
            ...
            %         splittype = 4;
            %         Dist1rmin = rminCalc(aa,ab,ac,ad,xa,xb,xc,xd,splittype); %table 4.1 revised
            ...
            %         Dist1F = PEther.(labelP{countP}).(labelT{countT}) + PEthanol.(labelP{countP}).(labelT{countT}) ...
            %             + PEther.(labelP{countP}).(labelT{countT}) + PEtA;
            %         Dist1zF = xa;
            %         [Dist1Qc.(labelP{countP}).(labelT{countT}),Dist1Qr.(labelP{countP}).(labelT{countT}),...
            %             Dist1H.(labelP{countP}).(labelT{countT}),Dist1D.(labelP{countP}).(labelT{countT}), ...
            %             Dist1Nreal.(labelP{countP}).(labelT{countT}),Dist1r.(labelP{countP}).(labelT{countT}),...
            %             Dist1s.(labelP{countP}).(labelT{countT}),Dist1VoverF.(labelP{countP}).(labelT{countT})]...
            %             = dist_column(Dist1F,Dist1zF,Dist1rmin,Dist1P,Dist1T,Dist1lambdaD,Dist1lambdaB,Dist1MvFeed,Dist1MvDist,Dist1MvBottoms,aij);
            %         Dist1DSattemp = 80.1; %deg C, BP of benzene
            %         Dist1BSattemp = 110; %deg C, BP of bottoms mixture, estimate
            ...
            %         Ft = 0; %sieve
            %         d.(labelP{countP}).(labelT{countT}) = Dist1D.(labelP{countP}).(labelT{countT});
            %         d0 = 1; %m
            %         H0 = 6.1; %m
            %         as = 0.82;
            %         at = 1.8;
            %         CostShell = (MS./301).*(Fm.*Fp -1+Fi.*Fd).*5000.*(d.(labelP{countP}).(labelT{countT})./d0).*((Dist1H.(labelP{countP}).(labelT{countT})./H0).^as); %$
            %         CostTray = (MS./301).*(Fs + Ft + Fm).*5000.*((d.(labelP{countP}).(labelT{countT})./d0).^at).*(Dist1H.(labelP{countP}).(labelT{countT})./H0); %$
            ...
            %         ad = 1;
            %         aij = 2.2;
            %         xa = PEthanol.(labelP{countP}).(labelT{countT})./(PTotal.(labelP{countP}).(labelT{countT})-PEther.(labelP{countP}).(labelT{countT}));
            %         xb = PEtA./(PTotal.(labelP{countP}).(labelT{countT})-PEther.(labelP{countP}).(labelT{countT}));
            %         xc = PEther.(labelP{countP}).(labelT{countT})./(PTotal.(labelP{countP}).(labelT{countT})-PEther.(labelP{countP}).(labelT{countT}));
            %         xd = 0;
            %         Dist2MvFeed = xa.*MW.Ethanol + xb.*MW.EtA + xc.*MW.Ether;
            %         Dist2MvDist = xa.*MW.Ethanol./xa;
            %         Dist2MvBottoms = (xb.*MW.EtA + xc.*MW.Ether).*(1./(xb+xc));
            %         splittype = 1;
            %         Dist2rmin = rminCalc(aa,ab,ac,ad,xa,xb,xc,xd,splittype); %table 4.1 revised
            ...
            %         Dist2F = PEthanol.(labelP{countP}).(labelT{countT}) + PEther.(labelP{countP}).(labelT{countT}) + PEtA;
            %         Dist2zF = xa;
            %         [Dist2Qc.(labelP{countP}).(labelT{countT}),Dist2Qr.(labelP{countP}).(labelT{countT}),...
            %             Dist2H.(labelP{countP}).(labelT{countT}),Dist2D.(labelP{countP}).(labelT{countT}), ...
            %             Dist2Nreal.(labelP{countP}).(labelT{countT}),Dist2r.(labelP{countP}).(labelT{countT}),...
            %             Dist2s.(labelP{countP}).(labelT{countT}),Dist2VoverF.(labelP{countP}).(labelT{countT})]...
            %             = dist_column(Dist2F,Dist2zF,Dist2rmin,Dist2P,Dist2T,Dist2lambdaD,Dist2lambdaB,Dist2MvFeed,Dist2MvDist,Dist2MvBottoms,aij);
            %         Dist2DSattemp = 111; %deg C, BP of toluene
            %         Dist2BSattemp = 125; %deg C, BP of bottoms mixture, estimate
            ...
            %         Fs = 1; % (for 60 cm tray spacing)
            %         Ft = 0; %sieve
            %         d.(labelP{countP}).(labelT{countT}) = Dist2D.(labelP{countP}).(labelT{countT});
            %         d0 = 1; %m
            %         H0 = 6.1; %m
            %         as = 0.82;
            %         at = 1.8;
            %         CostShell = (MS./301).*(Fm.*Fp -1+Fi.*Fd).*5000.*(d.(labelP{countP}).(labelT{countT})./d0).*((Dist2H.(labelP{countP}).(labelT{countT})./H0).^as); %$
            %         CostTray = (MS./301).*(Fs + Ft + Fm).*5000.*((d.(labelP{countP}).(labelT{countT})./d0).^at).*(Dist2H.(labelP{countP}).(labelT{countT})./H0); %$
            ...
            %         ad = 1;
            %         aij = 2.1;
            %         xa = PEtA./(PEtA+PEther.(labelP{countP}).(labelT{countT}));
            %         xb = PEther.(labelP{countP}).(labelT{countT})./(PEtA+PEther.(labelP{countP}).(labelT{countT}));
            %         xc = 0;
            %         xd = 0;
            ...
            %         splittype = 10;
            %         Dist3rmin = rminCalc(aa,ab,ac,ad,xa,xb,xc,xd,splittype); %table 4.1 revised
            %         Dist3lambdaD = lambda.ParaX; %latent heat of distillate mixture
            %         Dist3lambdaB = lambda.TMB; %latent heat of bottoms mixture
            %         Dist3F = PEther.(labelP{countP}).(labelT{countT}) + PEtA;
            %         Dist3zF = xa;
            %         [Dist3Qc.(labelP{countP}).(labelT{countT}),Dist3Qr.(labelP{countP}).(labelT{countT}),...
            %             Dist3H.(labelP{countP}).(labelT{countT}),Dist3D.(labelP{countP}).(labelT{countT}), ...
            %             Dist3Nreal.(labelP{countP}).(labelT{countT}),Dist3r.(labelP{countP}).(labelT{countT}),...
            %             Dist3s.(labelP{countP}).(labelT{countT}),Dist3VoverF.(labelP{countP}).(labelT{countT})]...
            %             = dist_column(Dist3F,Dist3zF,Dist3rmin,Dist3P,Dist3T,Dist3lambdaD,Dist3lambdaB,MvFeed,MvDist,MvBottoms,aij);
            %         Dist3DSattemp = 138.4; %deg C, BP of paraX
            %         Dist3BSattemp = 170; %deg C, BP of bottoms mixture, estimate
            %         Dist3CoolingWaterCoolTemp = 25; % deg C
            %         Dist3CoolingWaterHotTemp = Dist1CoolingWaterCoolTemp + 15; % deg C
            %         Dist3SteamTemp = 250; % deg C, 600 psia steam
            %         Dist1dTlmD.(labelP{countP}).(labelT{countT}) = ...
            ...
            %         Fs = 1; % (for 60 cm tray spacing)
            %         Ft = 0; %sieve
            %         d.(labelP{countP}).(labelT{countT}) = Dist3D.(labelP{countP}).(labelT{countT});
            %         d0 = 1; %m
            %         H0 = 6.1; %m
            %         as = 0.82;
            %         at = 1.8;
            %         CostShell = (MS./301).*(Fm.*Fp -1+Fi.*Fd).*5000.*(d.(labelP{countP}).(labelT{countT})./d0).*((Dist3H.(labelP{countP}).(labelT{countT})./H0).^as); %$
            %         CostTray = (MS./301).*(Fs + Ft + Fm).*5000.*((d.(labelP{countP}).(labelT{countT})./d0).^at).*(Dist3H.(labelP{countP}).(labelT{countT})./H0); %$
            ...
            %         Dist3HXBOpCost.(labelP{countP}).(labelT{countT}) = Dist3QrBTU.(labelP{countP}).(labelT{countT})*Price.Fuel*1.13; %$/hr
            ...
            %             Dist3Qr.(labelP{countP}).(labelT{countT});
            ...
            %             Dist3ColumnCost.(labelP{countP}).(labelT{countT});
            ...
            %             Dist3HXDOpCost.(labelP{countP}).(labelT{countT}) + ...
            %             Dist1HXBOpCost.(labelP{countP}).(labelT{countT}) + ...
            %             Dist2HXBOpCost.(labelP{countP}).(labelT{countT}) + ...
            %             Dist3HXBOpCost.(labelP{countP}).(labelT{countT});
        end
        
        DistCost.(labelP{countP}).(labelT{countT}) = zeros(length(A),1); %ignoring cost
        %         DistCost.(labelP{countP}).(labelT{countT}) = 2.5./xt.(labelP{countP}).(labelT{countT}); %MM$ %using fake correlation
        DistOpCost.(labelP{countP}).(labelT{countT}) = zeros(length(A),1); %ignoring operating cost
        %         DistOpCost.(labelP{countP}).(labelT{countT}) = (500000./xt.(labelP{countP}).(labelT{countT}))/1e6; %MM$ %using fake correlation
...
for z=1
    ...
    for i = 225:5:240
        ...
        plot(tau.(labelP{countP}).(labelT{countT}).*60,Ethanol.(labelP{countP}).(labelT{countT}),'Color',cc(countT,:),'LineWidth',1.5)
    ...
    legend(['225' char(176) 'C'],['230' char(176) 'C'],['235' char(176) 'C'],...
        ['240' char(176) 'C'],'Location','NE','FontSize',11)
    ...
    for i = 225:5:240
        ...
        hold on
        plot((tau.(labelP{countP}).(labelT{countT})).*60,EtA.(labelP{countP}).(labelT{countT}),'Color',cc(countT,:),'LineWidth',1.5)
    ...
    for i = 225:5:240
        ...
        %
        hold on
        plot(xt.(labelP{countP}).(labelT{countT}),sEtA.(labelP{countP}).(labelT{countT}),'Color',cc(countT,:),'LineWidth',1.5)
    ...
    for i = 225:5:240
        countT = (i - 225)/5 + 1;
        hold on
        plot(xt.(labelP{countP}).(labelT{countT}),Revenue.(labelP{countP}).(labelT{countT}),'Color',cc(countT,:),'LineWidth',1.5)
    ...
    for i = 225:5:240
        countT = (i - 225)/5 + 1;
        hold on
        plot(xt.(labelP{countP}).(labelT{countT}),Vreal.(labelP{countP}).(labelT{countT})./1000,'Color',cc(countT,:),'LineWidth',1.5)
        xlabel('Ethanol Conversion');
    ...
    for i = 225:5:240
        countT = (i - 225)/5 + 1;
        hold on
        plot(xt.(labelP{countP}).(labelT{countT}),(FEthanol.(labelP{countP}).(labelT{countT})-PEthanol.(labelP{countP}).(labelT{countT})),'Color',cc(countT,:),'LineWidth',1.5)
    ...
    for i = 225:5:240
        ...
        yyaxis left
        hold on
        plot(xt.(labelP{countP}).(labelT{countT}),NPV.(labelP{countP}).(labelT{countT}),'Color',cc(countT,:),'LineStyle','-','Marker','none','LineWidth',1.5)
        xlabel('Ethanol Conversion')
        ...
        yyaxis right
        hold on
        plot(xt.(labelP{countP}).(labelT{countT}),NPVpercent.(labelP{countP}).(labelT{countT}),'Color',cc(countT,:),'LineStyle','-.','Marker','none','LineWidth',1.5)
        ylabel('NPV_%')
                axis([0 0.6 35 95])
    end
    ...
    for i = 240
        ...
        plot(xt.(labelP{countP}).(labelT{countT}),PEther.(labelP{countP}).(labelT{countT})./PTotal.(labelP{countP}).(labelT{countT}),...
            ...
            xt.(labelP{countP}).(labelT{countT}),PEthanol.(labelP{countP}).(labelT{countT})./PTotal.(labelP{countP}).(labelT{countT}),'LineWidth',1.5)
        yline = [-30:300]';
        oppoint = 0.25;
%         plot(zeros(length(yline),1)+oppoint,yline,'LineStyle','--','Color','k','Linewidth',1,'Marker','none')
    ...
    for i = 225:5:240
        countT = (i - 225)/5 + 1;
        hold on
        plot(NPV.(labelP{countP}).(labelT{countT}),NPVpercent.(labelP{countP}).(labelT{countT}),'Color',cc(countT,:),'LineWidth',1.5)
    end
    %     axis([40 80 0 30])
    ylabel('NPV_%')
    ...
    for i = 225:5:240
        ...
        hold on
        plot(xt.(labelP{countP}).(labelT{countT}),IRRplot.(labelP{countP}).(labelT{countT}),'Color',cc(countT,:),'LineWidth',1.5)
    end
    %     axis([0 0.6 0 45])
    ylabel('IRR [%]')
    xlabel('Ethanol Conversion')
    ...
    for i = 225:5:240
        countT = (i - 225)/5 + 1;
        hold on
        plot(xt.(labelP{countP}).(labelT{countT}),ROIBT.(labelP{countP}).(labelT{countT}),'Color',cc(countT,:),'LineWidth',1.5)
    end
    %     axis([0 0.6 -10 70])
    ylabel('ROI_{BT} [%]')
    xlabel('Ethanol Conversion')
    ...
    for i = 225:5:240
        countT = (i - 225)/5 + 1;
        hold on
        plot(xt.(labelP{countP}).(labelT{countT}),TI.(labelP{countP}).(labelT{countT}),'Color',cc(countT,:),'LineWidth',1.5)
    end
    %     axis([0 0.6 0 100])
    ylabel('TCI [MM$]')
    xlabel('Ethanol Conversion')
    ...
    for i = 240
        ...
        yyaxis left
        hold on
        plot(xt.(labelP{countP}).(labelT{countT}),ROIBT.(labelP{countP}).(labelT{countT}),'Color','k','LineStyle','-','Marker','none','LineWidth',1.5)
        xlabel('Ethanol Conversion')
        ylabel('ROI_{BT} [%]')
        %         axis([0 0.6 -10 70])
        ...
        yyaxis right
        hold on
        plot(xt.(labelP{countP}).(labelT{countT}),TI.(labelP{countP}).(labelT{countT}),'Color','k','LineStyle','-.','Marker','none','LineWidth',1.5)
        ylabel('TCI [MM $]')
        %         axis([0 0.6 0 100])
    end
    ...
    %     oppoint = 0.25;
    %     plot(zeros(length(yline),1)+oppoint,yline,'LineStyle','--','Color','k','Linewidth',1,'Marker','none')
    legend(['ROI_{BT}'],['TI'],'Location','NE','FontSize',11)
    ...
    for i = 240
        countT = (i - 225)/5 + 1;
        hold on
        plot(xt.(labelP{countP}).(labelT{countT}),PTotal.(labelP{countP}).(labelT{countT}),'Color',cc(countT,:),'LineWidth',1.5)
    ...
    for j = 2:2:10
        ...
        yyaxis left
        hold on
        plot(xt.(labelP{countP}).(labelT{countT}),NPV.(labelP{countP}).(labelT{countT}),'Color',cc(countP,:),'LineStyle','-','Marker','none','LineWidth',1.5)
        ...
        yyaxis right
        hold on
        plot(xt.(labelP{countP}).(labelT{countT}),NPVpercent.(labelP{countP}).(labelT{countT}),'Color',cc(countP,:),'LineStyle','-.','Marker','none','LineWidth',1.5)
        ylabel('NPV_%')
        %         axis([0 0.6 0 30])
    end
    ...
    %
    legend(['2 atm'],['4 atm'],...
        ['6 atm'],['8 atm'],['10 atm'],'Location','NE','FontSize',11)
    %
    %
    %         %
    figure(figure17)
    for j = 2:2:10
        ...
        countP = (j-2)/2 + 1;
        hold on
        plot(xt.(labelP{countP}).(labelT{countT}),Vreal.(labelP{countP}).(labelT{countT})./1000,'Color',cc(countP,:),'LineWidth',1.5)
        xlabel('Ethanol Conversion');
        ylabel('Reactor Volume [m^3]')
    end
    %     axis([0 0.6 0 3*10^3])
    ...
    %     oppoint = 0.25;
    %     plot(zeros(length(yline),1)+oppoint,yline,'LineStyle','--','Color','k','Linewidth',1,'Marker','none')
    legend('2 atm','4 atm','6 atm','8 atm','10 atm','Location','NE','FontSize',11)
